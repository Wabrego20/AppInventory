...
<head>
    ...
    <link rel="stylesheet" href="../css/3_inventory4.css">
    <link rel="stylesheet" href="https://cdn.datatables.net/1.10.21/css/jquery.dataTables.css">
    <title>Ayuda Social | Sist-Inventario</title>
</head>
...
<body>
    ...
    <div class="ruta2">
        ...
        <h4>Inventario de Ayuda Social</h4>
    </div>

    <!--Cuerpo Principal-->
    <main>
        <h2>Tabla de Articulos de Ayuda Social</h2>
        <table id="tableInventory">
            ...
            <tbody>
                ...
                AND inventory.inventory_name = 'Ayuda Social'";
        ...
        <div class="modalAddArticle">
            <div class="panelArticle">
                <form method="post" class="formArticle">
                    <h2>Agregar Artículo de Ayuda Social</h2>
            ...
            <div class="panelArticle">
                <form method="post" class="formArticle" id="beneficiaryForm">
                    ...
                    <div class="formArticle" id="datosPrograma" style="display:none;">
                        ...
                        <!--campo de nombre-->
                        <div class="formLogCampo">
                            <label for="benefited_program">Nombre de ONG:<i
    ...
    <script src="../js/3_inventory4.js"></script>
...
if (isset($_POST['agregarDonacion'])) {
    ...
    $re_order = $quantity / 3;
    $checkQuery = $conn->prepare("SELECT * FROM inventory WHERE articles_id = ? AND warehouses_id = ? AND categories_id = ? AND inventory_name ='Ayuda Social' ");
