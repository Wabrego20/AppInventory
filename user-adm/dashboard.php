...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css" rel="stylesheet" integrity="sha512-MV7K8+y+gLIBoVD59lQpaQnP+u8xY8ts4rIAq17xvvWXoX/qeO5RYj/rCO+N4LXEoOpwT<ctrl61>tVhUVNU6lV+0vYCj"   crossorigin="anonymous" referrerpolicy="no-referrer">
...
<body>
               ...
               <form action="" class="formEditUser">
                    ...
                    <div class="formLogCampo">
                        ...
                        <div class="campo">
                            ...
                            <input class="btnTxt" type="text" name="users_dni" id="users_dni" pattern="[a-zA-Z0-9]{1,2}-[0-9]{2,4}-[0-9]{2,4}" maxlength="14"
                    ...
                    <div class="formLogCampo">
                        ...
                        <div class="campo">
                            ...
                            <input class="btnTxt" type="text" name="users_name" id="users_name" pattern="[a-zA-Z]{4,15}" maxlength="15"
                    ...
                    <div class="formLogCampo">
                        ...
                        <div class="campo">
                            ...
                            <input class="btnTxt" type="text" name="users_last_name" id="users_last_name" pattern="[a-zA-Z]{4,15}" maxlength="15"
                    ...
                    <div class="formLogCampo">
                        ...
                        <div class="campo">
                            ...
                            placeholder="introduzca su usuario por favor:" required>
                        </div>
                    </div>
                    ...
                    <div class="formLogCampo">
                        ...
                        <div class="campo">
                            ...
                            <input class="btnTxt" type="password" name="users_password" id="users_password" pattern=".{8,15}" maxlength="15"
                            placeholder="introduzca su contraseña por favor:" required>
    ...
    <!--Cuerpo Principal-->
    <main>
        <a class="btn_seccion" href="registro_articulos.php">
            <h2>Artículos</h2>
            <img src="../gif/inventario.gif" alt="article">
            <h4>Ver material operativo, Donaciones, Compras para ayuda social y Material en tránsito.</h4>
        </a>
        ...
        <a class="btn_seccion" href="settings.php">
            ...
            <h4>Configurar alertas específicas para cada tipo de inventario, como niveles bajos o fechas de caducidad.</h4>
        </a>
    </main>
